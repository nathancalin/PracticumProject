...
function Form() {
    ...
    const [inputState, setInputState] = useState({
        ...
        orNumber: '', // Add orNumber
        trancheNo: '', // Add trancheNo
        recordedBy: '', // Add recordedBy
    });

    const { title, amount, date, category, description, projectName, orNumber, trancheNo, recordedBy } = inputState;
